...
namespace IChiba.Services.Localization
{
    ...
    public partial interface ILocalizedEntityService
    {
        ...
        LocalizedProperty GetLocalizedPropertyById(string localizedPropertyId);
        ...
        string GetLocalizedValue(string languageId, string entityId, string localeKeyGroup, string localeKey);
