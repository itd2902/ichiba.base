...
namespace IChiba.Services.Configuration
{
    /// <summary>
    /// Setting manager
    /// </summary>
    public partial class SettingService : ISettingService
    {
        ...
        protected virtual IDictionary<string, Setting> GetAllSettingsDictionary()
        {
        ...
        public virtual Setting GetSettingById(string settingId)
        {
            ...
            return _cacheManager.GetToDb(key, () => _settingRepository.GetById(settingId), CachingDefaults.MonthCacheTime);
        }
        ...
        {
            _cacheManager.HybridProvider.RemoveByPrefix(MasterCacheKeys.Settings.PrefixCacheKey);
        }
