...
namespace IChiba.Web.Framework.Mvc.ModelBinding
{
    ...
    /// </summary>
    public class IChibaModelBinder : ComplexTypeModelBinder
    {
        #region Ctor
        ...
        public IChibaModelBinder(IDictionary<ModelMetadata, IModelBinder> propertyBinders, ILoggerFactory loggerFactory)
        ...
        protected override object CreateModel(ModelBindingContext bindingContext)
        {
            ...
            if (model is BaseIChibaModel)
                (model as BaseIChibaModel).BindModel(bindingContext);
            ...
            ModelMetadata propertyMetadata, ModelBindingResult bindingResult)
        {
            ...
            if (bindingContext.Model is BaseIChibaModel && !string.IsNullOrEmpty(valueAsString))
            {
