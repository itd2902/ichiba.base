...
namespace IChiba.Web.Framework.Mvc.ModelBinding
{
    ...
    /// </summary>
    public class IChibaMetadataProvider : IDisplayMetadataProvider
    {
        /// <summary>
        ...
        public void CreateDisplayMetadata(DisplayMetadataProviderContext context)
        {
            ...
            foreach (var additionalValue in additionalValues)
            {
                if (context.DisplayMetadata.AdditionalValues.ContainsKey(additionalValue.Name))
                    throw new IChibaException("There is already an attribute with the name '{0}' on this model", additionalValue.Name);
